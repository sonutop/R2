...
TELEGRAM_BOT_TOKEN = '8160827648:AAE92gHENz-paNLsnDWOnKjhrIHGSzj8MTw'
...
async def bgmi(update: Update, context: CallbackContext):
    ...
    if str(chat_id) not in approved_ids and user_id not in approved_ids:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ buy karo Rs300 mai 30 dyas pay kar k🤝.*", parse_mode='Markdown')
        return
